# Bootstrappable Vault Builds

This directory contains the files necessary to perform bootstrappable Vault 
builds.
...
To build Vault reproducibly with all default options, invoke the
...
repository](https://github.com/vault-project/guix.sigs).
