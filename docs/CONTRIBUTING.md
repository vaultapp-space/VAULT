...
posted to #vault-dev on irc.libera.chat).
...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to Vault code or Vault's dependency code or Vault's potential/future dependency code or research which successfully implements Vault.
...
- Maintainers SHOULD NOT merge their own patches unless they were added to the merge queue on irc and have at least 2 approvals from contributors OR unless urgent as defined by the Vault Maintainers Team.
...
- The Vault Core Team MUST act as Administrators to manage the set of project Maintainers.
