# Vault Blockchain Stats

Vault Blockchain Stats utility exports daily statistics for the vault blockchain from creation through current state.

## Usage:

See also the utility's help option. `vault-blockchain-stats --help`
...
- `vault-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `vault-blockchain-stats | save-to-database.sh`
